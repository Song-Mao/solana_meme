...
var MonitorService = /** @class */ (function () {
    function MonitorService(monitorRepo, walletRepo) {
        ...
        this.solanaConnection = new web3_js_1.Connection(rpcUrl);
        // 测试连接
        this.testConnection();
    }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.solanaConnection.getSlot()];
                    case 1:
                        slot = _a.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        walletPromises = createMonitorDto.wallets.map(function (walletInput) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                switch (_d.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, Promise.all([
                                                this.getTokenBalance(walletInput.address, createMonitorDto.tokenAddress),
                                                this.getSolBalance(walletInput.address),
                                                this.getTokenBalance(walletInput.address, this.USDT_ADDRESS),
                                                this.getTokenBalance(walletInput.address, this.USDC_ADDRESS)
                                            ])];
                                    case 1:
                                    ...
                                    case 2:
                                        ...
                                        return [2 /*return*/, this.walletRepo.save(wallet)];
                                }
                            });
                        }); });
                        return [4 /*yield*/, Promise.all(walletPromises)];
                    case 3:
                        _b.sent();
                        return [2 /*return*/, this.monitorRepo.findOne({
                                where: { id: savedMonitor_1.id },
                                relations: ['wallets']
                            })];
                    case 4:
                        error_2 = _b.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, spl_token_1.getMint(this.solanaConnection, new web3_js_1.PublicKey(tokenAddress))];
                    case 1:
                        mintInfo = _a.sent();
                        // 这里需要调用 token metadata program 获取更多信息
                        // 临时返回基础信息
                        return [2 /*return*/, {
                                name: 'Unknown Token',
                                symbol: 'UNKNOWN',
        ...
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.monitorRepo.find({
                                relations: ['wallets']
                            })];
                    case 1:
                        monitors = _a.sent();
        ...
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, this.monitorRepo.findOne({
                                where: { id: id },
                                relations: ['wallets']
                            })];
                    case 1:
                        ...
                        return [4 /*yield*/, Promise.all(monitor_1.wallets.map(function (wallet) { return __awaiter(_this, void 0, void 0, function () {
                                var _a, tokenBalance, solBalance, usdtBalance, usdcBalance, tokenBalanceChange, solValueInUsdt, _b;
                                return __generator(this, function (_c) {
                                    switch (_c.label) {
                                        case 0: return [4 /*yield*/, Promise.all([
                                                this.getTokenBalance(wallet.address, monitor_1.tokenAddress),
                                                this.getSolBalance(wallet.address),
                                                this.getTokenBalance(wallet.address, this.USDT_ADDRESS),
                                                this.getTokenBalance(wallet.address, this.USDC_ADDRESS)
                                            ])];
                                        case 1:
                                            ...
                                            return [4 /*yield*/, this.getSolPrice()];
                                        case 2:
                                            solValueInUsdt = (_b * (_c.sent())).toString();
                                            // 更新钱包信息
                                            return [4 /*yield*/, this.walletRepo.update(wallet.id, {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.solanaConnection.getTokenAccountsByOwner(walletPubkey, { mint: tokenPubkey })];
                    case 1:
                        tokenAccounts = _a.sent();
                        if (tokenAccounts.value.length === 0) {
                            return [2 /*return*/, '0'];
                        }
                        return [4 /*yield*/, this.solanaConnection.getTokenAccountBalance(tokenAccounts.value[0].pubkey)];
                    case 2:
                        balance = _a.sent();
        ...
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.solanaConnection.getBalance(new web3_js_1.PublicKey(walletAddress))];
                    case 1:
                        balance = _a.sent();
                        return [2 /*return*/, (balance / 1e9).toString()]; // 转换为 SOL
                    case 2:
                        error_7 = _a.sent();
    ...
    MonitorService = __decorate([
        ...
        __param(1, typeorm_1.InjectRepository(wallet_entity_1.Wallet))
    ], MonitorService);
