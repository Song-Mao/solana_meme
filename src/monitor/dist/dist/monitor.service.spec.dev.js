...
function () {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            savedMonitor = _a.sent(); // 4. 初始化所有钱包的余额记录

            return [4
            /*yield*/
            , this.initializeBalanceRecords(savedMonitor)];
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            ...
            return [4
            /*yield*/
            , Promise.all(monitor.wallets.map(function (wallet) {
              return __awaiter(_this, void 0, void 0, function () {
                var balance;
                return __generator(this, function (_a) {
                  balance = balances.find(function (b) {
                    return b.walletAddress === wallet.address;
                  });
                  return [2
                  /*return*/
                  , {
  ...
  MonitorService = __decorate([common_1.Injectable(), __param(0, typeorm_1.InjectRepository(monitor_entity_1.Monitor)), __param(1, typeorm_1.InjectRepository(balance_record_entity_1.BalanceRecord))], MonitorService);
