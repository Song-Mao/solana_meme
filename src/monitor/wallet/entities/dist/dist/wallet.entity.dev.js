...
function () {
  ...
  __decorate([typeorm_1.PrimaryGeneratedColumn('uuid')], Wallet.prototype, "id");

  __decorate([typeorm_1.Column()], Wallet.prototype, "address");

  __decorate([typeorm_1.Column()], Wallet.prototype, "note");

  __decorate([typeorm_1.Column('text', {
    "default": '0'
  ...
  __decorate([typeorm_1.ManyToOne(function () {
    return monitor_entity_1.Monitor;
  }, function (monitor) {
    return monitor.wallets;
  })], Wallet.prototype, "monitor");

  Wallet = __decorate([typeorm_1.Entity()], Wallet);
  return Wallet;
}();
